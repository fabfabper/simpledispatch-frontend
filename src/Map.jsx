...
import { leafletIconForType } from "./leafletIconForType";
...
function Map({ events, units, selectedId, selectedType, onMarkerClick }) {
  ...
  if (selectedType === "event") {
    ...
    if (unit) selectedPosition = unit.position;
  }
      ...
      >
        ...
        {events.map((event) => (
          <Marker
            ...
            icon={leafletIconForType(event.type, {
              size:
                selectedType === "event" && selectedId === event.id ? 40 : 32,
              iconSize:
        ...
        {units.map((unit) => (
          <Marker
            ...
            icon={leafletIconForType(unit.type, {
              ...
              iconAnchor:
                selectedType === "unit" && selectedId === unit.id
                  ? [20, 40]
                  : [16, 32],
              color: statusMap[unit.statusId] || "#555",
            })}
            eventHandlers={{
